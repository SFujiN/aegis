...
/**
 * @brief Returns an in that is the index representation of a candidate from an IR ballot.
 * 
 * @param ballot a string that represents ballot information.
 * 
...
/**
 * @brief Parse and pop a string between the first occurence of two symbols l and r.
 * 
